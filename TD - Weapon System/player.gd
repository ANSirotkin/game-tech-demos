...
var available_weapons: Array[Resource] = [load("res://sword.tscn")]
...
func _ready():
	equipped_weapon = available_weapons[0].instantiate()
...
func use_weapon():
	if Input.is_action_pressed("attack") && equipped_weapon.can_attack:
		equipped_weapon.attack()
	elif Input.is_action_pressed("alternate") && equipped_weapon.can_alternate:
